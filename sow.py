...
if st.button("✨ Generate Full SOW", type="primary", use_container_width=True):
    with st.spinner("Generating document..."):
        ...
        STRICT INSTRUCTION:
        You must generate content ONLY under the following fixed headings.
        Do NOT rename, remove, or add headings.
        Do NOT add extra sections.

        ## 5.1 Infrastructure Setup
        (Generate detailed implementation steps here)

        ## 5.2 Create Core Workflows
        (Generate detailed workflow steps here)

        ## 5.3 Backend Components
        (Generate backend services, integrations, and data flow here)

        ## 5.4 Testing and Feedback
        (Generate validation, benchmarking, and iteration steps here)
